  ...
  return (
    <div className="bg-blue-900 text-white py-2 px-4 flex flex-wrap justify-between items-center text-sm">
      ...
      <div className="flex flex-wrap gap-x-6 gap-y-2">
        <div className="flex items-center space-x-2">
          <FontAwesomeIcon icon={faPhone} className="text-green-400" />
          <span className="hidden sm:inline">+91 7766912144</span>
        </div>
        <div className="flex items-center space-x-2">
          <FontAwesomeIcon icon={faWhatsapp} className="text-green-400" />
          <span className="hidden sm:inline">+91 7766912143</span>
        </div>
        <div className="flex items-center space-x-2">
          <FontAwesomeIcon icon={faEnvelope} className="text-green-400" />
          <span className="hidden sm:inline">
      ...
      <div className="flex items-center space-x-4">
        <a href="https://www.facebook.com/share/1XkdxkHGKP/" aria-label="Facebook" className="hover:text-gray-300 transition-all">
          <FontAwesomeIcon icon={faFacebook} />
        </a>
        <a href="https://twitter.com" aria-label="Twitter" className="hover:text-gray-300 transition-all">
          <FontAwesomeIcon icon={faTwitter} />
        ...
        <a href="https://www.instagram.com/r_b_memorial_school_of_nursing?igsh=MXJ1NmkxOHNseWF6Zw==" aria-label="LinkedIn" className="hover:text-gray-300 transition-all">
