...
const fullMenu = {
        "Soups / Drinks": [
          ...
          { name: "Butter Milk ", price: "₹49", img: "/assets/menu/lassi.webp" },
          ...
          { name: "Soda", price: "₹50", img: "/assets/menu/LemonWater.webp" }
        ],
        Appetizers: [
        ...
        "Special Combo Meal": [
          { name: "Dal Rice", price: "₹149", img: "/assets/menu/onion-salad.jpg" },
          { name: "Chole Rice", price: "₹149", img: "/assets/menu/green-salad.jpg" },
          { name: "Rajma Rice", price: "₹149", img: "/assets/menu/grilled-paneer.jpg" },
          ...
          { name: "Noodles Manchurian", price: "₹199", img: "/assets/menu/italian.jpg" },
