...
//     // Don't automatically open drawer when adding items
//   };
...
//       {/* Order Drawer - Only opens when manually triggered */}
...
//                       <p className="text-[#d63447]">{item.price}</p>
//                     </div>
//                   </div>
...
//                 <a
//                   href="/my-orders"
//                   className="block mt-4 text-center bg-[#192f59] text-white py-2 rounded-lg hover:bg-[#101f40] transition"
//                 >
//                   Proceed to Checkout →
//                 </a>
//               </div>
...
//       {/* Floating Cart Button - Always visible when items are in cart */}
//       {myOrders.length > 0 && (
//         <button
