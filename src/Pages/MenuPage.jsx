...
// const fullMenu = {
//   "Soups / Drinks": [
//     { name: "Hot and Sour", price: "₹149", img: "/assets/menu/hot-sour.jpg" },
//     { name: "Veg Manchow", price: "₹149", img: "/assets/menu/manchow.jpg" },
//     { name: "Lemon Coriander", price: "₹149", img: "/assets/menu/lemon-coriander.jpg" },
...
//   ],
//   Appetizers: [
//     { name: "Paneer Tikka", price: "₹199", img: "/assets/menu/paneer-tikka.jpg" },
...
//     const visible = visibleCount[category] || 3;
//     return (
//       <div className="mb-14" key={category}>
//         <h2 className="text-2xl font-bold text-[#192f59] mb-6">{category}</h2>
...
//                 <p className="text-[#d63447] font-semibold">{item.price}</p>
//               </div>
//             </motion.div>
//           ))}
//         </div>
...
//   return (
//     <div className="bg-gradient-to-br from-yellow-50 via-rose-50 to-white min-h-screen">
//       <TopHeader />
//       <Navbar />

//       <div className="container mx-auto px-4 py-10">
//         <h1 className="text-4xl font-bold text-center text-[#d63447] mb-6">Discover Our Menu</h1>
...
//           <a
//             href="/my-orders"
//             className="inline-block bg-[#192f59] text-white px-6 py-3 rounded-lg hover:bg-[#101f40] transition"
//           >
//             Order / View Combos →
//           </a>
//         </div>
...
//                   className="mt-2 px-4 py-2 bg-[#d63447] text-white rounded-lg hover:bg-[#b52c3c] transition"
//                 >
//                   {myOrders.some((order) => order.name === item.name) ? "Added" : "Add"}
//                 </button>
//               </div>
//             </motion.div>
//           ))}
