...
const fullMenu = {
        ...
        Appetizers: [
          { name: "Paneer Tikka", price: "₹249", img: "/assets/menu/panirtikkaa.jpg" },
          { name: "Achari Paneer Tikka", price: "₹249", img: "/assets/menu/achariPanir.webp" },
          { name: "Lehsuni Paneer Tikka", price: "₹249", img: "/assets/menu/Lehsuni Paneer Tikka.jpg" },
          { name: "Mushroom Tikka", price: "₹249", img: "/assets/menu/mishroomtikka.png" },
          { name: "Malai Soya Chaap", price: "₹249", img: "/assets/menu/malaiSoyaChap.jpeg" },
          { name: "Achari Soya Chaap", price: "₹249", img: "/assets/menu/Achari Soya Chaap.jpg" },
          { name: "Honey Chilli Potato", price: "₹199", img: "/assets/menu/honeyChilliPotato.png" },
          { name: "Chilli Potato", price: "₹169", img: "/assets/menu/honeyChilliPotato.png" },
          { name: "French Fries", price: "₹169", img: "/assets/menu/French Fries.jpg" },
        ...
        "Noodles & Pastas": [
          { name: "Hakka Noodles", price: "₹199", img: "/assets/menu/Hakka Noodles.jpg" },
          { name: "Chilli Garlic Noodles", price: "₹219", img: "/assets/menu/Chilli Garlic Noodles.jpg" },
          { name: "Mirchify Spl Pasta", price: "₹239", img: "/assets/menu/mirchifySplpasta.jpeg" },
          { name: "White Sauce Pasta", price: "₹149", img: "/assets/menu/White Sauce Pasta.jpg" },
          { name: "Tangy Tomato Pasta", price: "₹149", img: "/assets/menu/Tangy Tomato Pasta.webp" },
          { name: "Mirchify Spl Noodles", price: "₹169", img: "/assets/menu/special Noodles.jpg" },
        ],
        "Healthify (Salad Bowls)": [
        ...
        Parathas: [
          { name: "Aloo Paratha", price: "₹75", img: "/assets/menu/Aloo Paratha.jpg" },
          { name: "Aloo Pyaz Paratha", price: "₹75", img: "/assets/menu/Aloo Pyaz Paratha.jpg" },
          { name: "Paneer Paratha", price: "₹85", img: "/assets/menu/Paneer Paratha.jpg" },
          { name: "Gobhi Paratha", price: "₹80", img: "/assets/menu/Gobhi Paratha.webp" },
          { name: "Sattu Paratha", price: "₹85", img: "/assets/menu/Sattu Paratha.jpg" },
        ],
        "Rice & Biryani": [
          { name: "Plain Rice", price: "₹120", img: "/assets/menu/Plain Rice.jpg" },
          { name: "Jeera Rice", price: "₹140", img: "/assets/menu/Jeera Rice.webp" },
          { name: "Vegetable Fried Rice", price: "₹175", img: "/assets/menu/Vegetable Fried Rice.webp" },
          { name: "Lemon Rice", price: "₹159", img: "/assets/menu/Lemon Rice.jpg" },
          { name: "Matar Pulao", price: "₹149", img: "/assets/menu/Matar Pulao.jpg" },
          { name: "Curd Rice", price: "₹199", img: "/assets/menu/Curd Rice.jpg" },
          { name: "Veg Biryani", price: "₹249", img: "/assets/menu/Veg Biryani.jpg" },
          { name: "Paneer Biryani", price: "₹279", img: "/assets/menu/Paneer Biryani.jpg" },
          { name: "Veg Paneer Fried Rice", price: "₹199", img: "/assets/menu/Veg Paneer Fried Rice.jpg" },
        ],
        Raita: [
          { name: "Boondi Raita", price: "₹99", img: "/assets/menu/Boondi Raita.jpg" },
          { name: "Mix Raita", price: "₹99", img: "/assets/menu/Mix Raita.jpg" },
          { name: "Cucumber Raita", price: "₹99", img: "/assets/menu/Cucumber Raita.jpg" },
          { name: "Pineapple Raita", price: "₹119", img: "/assets/menu/Pineapple Raita.jpg" },
        ],
        "On-the-Go Menu": [
